...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.validateGML_radioButton = QtWidgets.QRadioButton(Dialog)
        self.validateGML_radioButton.setObjectName("validateGML_radioButton")
        self.gridLayout_2.addWidget(self.validateGML_radioButton, 0, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.validateXML_radioButton, 1, 0, 1, 1)
        self.chooseGML_widget = QgsFileWidget(Dialog)
        self.chooseGML_widget.setEnabled(False)
        self.chooseGML_widget.setObjectName("chooseGML_widget")
        self.gridLayout_2.addWidget(self.chooseGML_widget, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.chooseXML_widget, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.validateGML_radioButton.setText(_translate("Dialog", "Walidacja GML"))
