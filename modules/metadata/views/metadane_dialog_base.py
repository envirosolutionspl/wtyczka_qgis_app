...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_4.addWidget(self.existingMetadata_radioButton, 0, 0, 1, 1)
        ...
        self.newFile_widget = QtWidgets.QPushButton(Dialog)
        self.newFile_widget.setEnabled(False)
        self.newFile_widget.setObjectName("newFile_widget")
        self.gridLayout_5.addWidget(self.newFile_widget, 0, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.newMetadata_radioButton, 0, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 676, 391))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.newFile_widget.setText(_translate("Dialog", "..."))
