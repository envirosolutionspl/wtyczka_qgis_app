...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 478, 211))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 478, 210))
        ...
        self.gridLayout_2.addWidget(self.laczeHelp_btn, 3, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.tytulHelp_btn, 2, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.legendaHelp_btn, 4, 5, 1, 1)
        self.tytulGetValues_btn = QtWidgets.QPushButton(self.scrollAreaWidgetContents_2)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.tytulGetValues_btn.setFont(font)
        self.tytulGetValues_btn.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.tytulGetValues_btn.setObjectName("tytulGetValues_btn")
        self.gridLayout_2.addWidget(self.tytulGetValues_btn, 2, 4, 1, 1)
        self.idGetValues_btn = QtWidgets.QPushButton(self.scrollAreaWidgetContents_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.idGetValues_btn.sizePolicy().hasHeightForWidth())
        self.idGetValues_btn.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.idGetValues_btn.setFont(font)
        self.idGetValues_btn.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.idGetValues_btn.setObjectName("idGetValues_btn")
        self.gridLayout_2.addWidget(self.idGetValues_btn, 0, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.idHelp_btn, 0, 5, 1, 1)
        self.laczeGetValues_btn = QtWidgets.QPushButton(self.scrollAreaWidgetContents_2)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.laczeGetValues_btn.setFont(font)
        self.laczeGetValues_btn.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.laczeGetValues_btn.setObjectName("laczeGetValues_btn")
        self.gridLayout_2.addWidget(self.laczeGetValues_btn, 3, 4, 1, 1)
        self.legendaGetValues_btn = QtWidgets.QPushButton(self.scrollAreaWidgetContents_2)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.legendaGetValues_btn.setFont(font)
        self.legendaGetValues_btn.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.legendaGetValues_btn.setObjectName("legendaGetValues_btn")
        self.gridLayout_2.addWidget(self.legendaGetValues_btn, 4, 4, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.instruction_lbl.setText(_translate("Dialog", "Instrukcja jak poprawnie wypełnić formularz atrybutów. Dla APP musi zostać wygenerowany dokładnie jeden formularz atrybutów."))
        ...
        self.tytulGetValues_btn.setText(_translate("Dialog", "<"))
        self.idGetValues_btn.setText(_translate("Dialog", "<"))
        ...
        self.laczeGetValues_btn.setText(_translate("Dialog", "<"))
        self.legendaGetValues_btn.setText(_translate("Dialog", "<"))
