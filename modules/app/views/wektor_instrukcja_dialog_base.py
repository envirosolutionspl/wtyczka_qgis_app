...
# Form implementation generated from reading ui file 'modules/app/views/ui/wektor_instrukcja_dialog_base.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 736, 348))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.instruction_lbl.setText(_translate("Dialog", "<html><head/><body><p>Dane przestrzenne APP obejmują m.in. wektorowe granice obowiązywania APP w <span style=\" font-weight:600;\">układzie PL-2000 lub PL-1992</span>. W warstwie wektorowej musi znajdować się tylko <span style=\" font-weight:600;\">jeden obiekt</span>, może być to np. <span style=\" font-weight:600;\">poligon lub multipoligon</span> (obiekty wieloczęściowe).</p><p>Granice APP są<span style=\" font-weight:600;\"> niezbędne</span> do wygenerowania pliku XML z atrybutami dla APP w kolejnym kroku. W przypadku posiadania wcześniej przygotowanego pliku XML z atrybutami dla APP, można wybrać opcję <span style=\" text-decoration: underline;\">Pomiń</span>. Przeniesie ona Użytkownika do okna Praca z APP (krok 5 z 6) Formularz atrybutów dla dokumentów formalnych. </p><p>W przypadku posiadania poprawnych granic APP należy wgrać plik do QGIS, a następnie wybrać go z listy rozwijalnej w oknie wtyczki i kliknąć przycisk <span style=\" text-decoration: underline;\">Dalej</span>. </p><p>W przypadku nieposiadania poprawnych granic APP należy je przygotować na podstawie istniejących plików (np. naprawić niepoprawne granice APP) lub stworzyć dane od zera. W przypadku tworzenia danych od podstaw można wybrać opcję <span style=\" text-decoration: underline;\">Stwórz pustą warstwę</span>, a następnie postępować zgodnie z <a href=\"https://www.envirosolutions.pl/\"><span style=\" text-decoration: underline; color:#0000ff;\">instrukcją</span></a>.<br/><br/><span style=\" font-weight:600;\">WAŻNE:</span> Warstwę tymczasową warto zapisać na dysku. W tym celu proszę wybrać format Geopackage. </p><p>Dzięki wyborowi tego formatu zapisu warstwy, w następnym kroku formularz atrybutów dla APP zostanie automatycznie wypełnionymi danymi znajdującymi się w poszczególnych kolumnach tabeli atrybutów tej warstwy.</p></body></html>"))
