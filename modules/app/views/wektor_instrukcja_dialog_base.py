...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 564, 234))
        ...
        self.verticalLayout.addWidget(self.addAppShp_lbl)
        ...
        self.chooseFile_btn = QgsFileWidget(Dialog)
        ...
        spacerItem = QtWidgets.QSpacerItem(563, 17, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.instruction_lbl.setText(_translate("Dialog", "Instrukcja tworzenia pliku wektorowego (wektoryzacja, odniesienia do narzędzi QGIS, link do filmiku instruktażowego, przypomnienie o zapisie edytowanej warstwy oraz o sposobie jej odtworzenia we wtyczce w przypadku wyjścia z QGIS). <br> WAŻNE: dane przestrzenne muszą być w układzie 2000 lub 1992 oraz w warstwie znajdować się może tylko jeden obiekt przestrzenny (może to być multipoligon)."))
        self.addAppShp_lbl.setText(_translate("Dialog", "Wybierz plik z z granicami APP (opcjonalne)"))
