...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 453, 426))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 453, 190))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.instruction_lbl.setText(_translate("Dialog", "<html><head/><body><p>Poniższy formularz dla dokumentów formalnych należy wypełnić zgodnie z informacjami zawartymi w podpowiedzi do każdego atrybutu (ikona znaku zapytania po prawej stronie każdego atrybutu).  Uzupełnienie pól oznaczonych gwiazdką jest obligatoryjne. </p><p>Po wypełnieniu formularza należy wybrać opcję <span style=\" font-style:italic;\">Zapisz aktualny formularz</span>, która spowoduje wygenerowanie pliku XML. </p><p>Jeżeli z danym APP powiązanych jest kilka dokumentów formalnych niezbędne będzie wypełnienie poniższego formularza tyle razy, ile dokumentów jest powiązanych z APP. Aby wypełnić formularz dla kolejnego dokumentu formalnego możesz: <br/>- zmodyfikować wpisane w formularzu dane, tak aby odnosiły się one do kolejnego dokumentu, a następnie ponownie zapisać aktualny formularz, <br/>- rozpocząć uzupełnianie formularza na nowo, wybierając opcję <span style=\" font-style:italic;\">Wyczyść formularz</span> (wszystkie obecne dane zostaną usunięte), <br/>- skorzystać z wcześniej wypełnionego i zapisanego formularza, wybierając opcję <span style=\" font-style:italic;\">Pobierz wartości z istniejącego formularza</span>, który odczyta plik XML i przypisze atrybutom analogiczne wartości. Następnie należy sprawdzić lub zmodyfikować wpisane w formularzu dane, tak aby odnosiły się one do kolejnego rysunku APP oraz ponownie zapisać aktualny formularz. </p><p>Należy pamiętać, że w końcowym kroku tego narzędzia, czyli w okienku <span style=\" font-style:italic;\">Generowanie GML</span> należy wgrać wszystkie (co najmniej jeden) formularze dla dokumentów formalnych.<span style=\" font-family:\'Times New Roman,serif\';\"/></p></body></html>"))
