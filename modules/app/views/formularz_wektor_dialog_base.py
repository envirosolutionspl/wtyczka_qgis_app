...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.instruction_lbl.setText(_translate("Dialog", "<html><head/><body><p>Poniższy formularz dla APP należy wypełnić zgodnie z informacjami zawartymi w podpowiedzi do każdego atrybutu (ikona znaku zapytania po prawej stronie). Część pól zostanie uzupełniona automatycznie na podstawie danych z wczytanego pliku z granicami APP. Uzupełnienie pól oznaczonych gwiazdką jest obligatoryjne. </p><p>Można skorzystać z wcześniej wypełnionego i zapisanego formularza, wybierając opcję <span style=\" text-decoration: underline;\">Pobierz wartości z istniejącego formularza</span>, który odczyta plik XML i przypisze atrybutom analogiczne wartości. Następnie należy sprawdzić lub zmodyfikować wpisane w formularzu dane, tak aby były poprawne dla danego APP oraz zapisać aktualny formularz. </p><p>Aby móc uzupełnić formularz na nowo, należy wybrać przycisk <span style=\" text-decoration: underline;\">Wyczyść formularz</span>. Wszystkie obecne dane zostaną usunięte. </p><p>Kiedy formularz zostanie wypełniony, należy wybrać opcję <span style=\" text-decoration: underline;\">Zapisz aktualny formularz</span>, spowoduje ona wygenerowanie pliku XML. </p><p>Należy pamiętać, że w końcowym kroku tego narzędzia, czyli w oknie <span style=\" text-decoration: underline;\">Praca z APP (krok 6 z 6) Generowanie GML dla APP</span>, trzeba będzie wgrać <span style=\" font-weight:600;\">dokładnie jeden</span> formularz dla APP. </p></body></html>"))
